                                    ...
                                    {!isLogin && (
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-14 pr-5 py-5 bg-[#f8f9ff] border-2 border-transparent rounded-[24px] text-sm font-bold text-gray-700 outline-none focus:bg-white focus:border-brand-200 focus:ring-4 focus:ring-brand-500/10 transition-all placeholder:text-gray-300"
                                            />
                                        </motion.div>
                                    )}
                                </AnimatePresence>
