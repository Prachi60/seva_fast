  ...
  try {
    ...
    if (!proximityCheck.inRange) {
      return {
        ...
        error: `Delivery person must be within 0-${process.env.NODE_ENV === "test" ? 120 : 300} meters of delivery location. Current distance: ${Math.round(proximityCheck.distance)}m`
      };
    }
